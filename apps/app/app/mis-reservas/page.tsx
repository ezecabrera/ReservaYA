...
import { DesktopReservas } from '@/components/lab/DesktopReservas'
...
export default function MisReservasPage() {
  ...
  useEffect(() => {
    try {
      const raw = localStorage.getItem('untoque-reviews')
  ...
  return (
    <div className="min-h-screen bg-bg pb-28 lg:pb-0">
      ...
      <DesktopReservas
        ...
        loading={loading}
        reviewed={reviewed}
        onReview={(r) => setReviewFor(r)}
        onCancel={(r) => setCancelFor(r)}
      />
