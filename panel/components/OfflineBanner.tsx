...
export function OfflineBanner() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed top-0 left-0 right-0 z-[60] bg-gold text-ink
                 text-[12.5px] font-bold text-center py-2 px-4
                 flex items-center justify-center gap-2
                 shadow-[0_4px_14px_-4px_rgba(201,145,48,0.55)]
                 animate-[slideDownBanner_0.32s_cubic-bezier(0.32,0.72,0,1)_both]"
      style={{ paddingTop: 'max(8px, env(safe-area-inset-top))' }}
    >
      <svg
        width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true"
        className="animate-[pulseSoft_1.6s_ease-in-out_infinite]"
      >
