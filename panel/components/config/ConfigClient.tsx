    ...
    <div className="min-h-screen pb-28"
      ...
      <div className="px-5 space-y-6">
        ...
        <div>
          ...
          <Link
            href="/dashboard/config/fotos"
            className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center gap-4 transition-colors hover:bg-white/[0.07]"
          >
            <div
              className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
              style={{ background: 'var(--wine-bg)', color: 'var(--wine-soft)', border: '1px solid var(--wine)' }}
              aria-hidden
            >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white font-bold text-[15px]">Fotos del local</p>
              <p className="text-white/45 text-[12px]">Logo, portada y galería para tu ficha pública</p>
            </div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white/40" aria-hidden>
